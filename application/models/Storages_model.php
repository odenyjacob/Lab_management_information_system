	...
	";
	  ...
	  ";
        ...
        for ($i = 0; $i < count($rResult); $i++) {
            $row = array();
            $row = $rResult[$i];
            $row['edit'] = "<a class='various btn btn-sm btn-success' data-fancybox-type='iframe' href='" . base_url() . "index.php/storages/popupadd/{$row['id']}'>edit</a>";
