			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: KEMRI PROGRAMS :::</h3>  
			  		</div>
			  		<div class="panel-body"> 
			  			
		<h2><hr /> KEMRI </h2>The KEMRI Science Programs  <hr />
        <div id="dynamic">

            <a class="various btn btn-sm btn-info" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/scipr/popupadd/">Add Program</a>
            <br/> <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/scipr/getSciPrTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "scipr_id"},
                    {"mDataProp": "scipr_name"},
                    {"mDataProp": "shortcode"},
                    {"mDataProp": "status"},
                    {"mDataProp": "username"}, 
                    {"mDataProp": "edit"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/Scipr/deleteSciPr'); ?>",
                        data: {scipr_id: id},
                        beforeSend: function() {
