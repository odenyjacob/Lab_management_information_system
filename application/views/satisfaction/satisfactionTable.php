			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: CUSTOMER SATISFACTION TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Customer Satisfaction Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/satisfaction/popupadd/"> Add new Satisfaction</a>
            <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/satisfaction/getSatisfactionTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "satisfaction_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "expectation_met"},
                    {"mDataProp": "expectation_not_met"},
                    {"mDataProp": "number_interviewed"},
                    {"mDataProp": "pc_expectation_met"},
                    {"mDataProp": "target"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "insights"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/satisfaction/deleteSatisfaction'); ?>",
                        data: {satisfaction_id: id},
                        beforeSend: function() {
