			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: RECEIVE/REJECT SAMPLES :::</h3>  
			  		</div>
			  		<div class="panel-body"> 
 			  			
		<h2><hr /> Receive/Reject Samples Table <hr /> </h2>
        <div id="dynamic">

            <!-- <a class="various btn btn-success" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/samples/samples_popup/">Add </a> -->
            <br/>  <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/samples/receiveSamplesTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "id"}, 
                    {"mDataProp": "sample_id"},  
                    {"mDataProp": "barcode"}, 
                    ...
                    {"mDataProp": "userName"}, 
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "receivesample"},
                    {"mDataProp": "rejectsample"}
                ],
                "aoColumnDefs": [
