			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: SAMPLE TYPES TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Sample Types Table <hr /> </h2>
        <div id="dynamic">

            <a class="various btn btn-sm btn-success" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/samples/sampletype_popup/">Add Sample Type</a>
            <br/>   <br/>
    ...
    <script>
        ...
        $(document).ready(function() {
                oTable = $('#dealList').dataTable({
                    ...
                    "bServerSide": true,
                    "bRedraw": true,
                    "sAjaxSource": "<?= base_url('index.php/samples/getSampleTypeTable'); ?>",
                    "aoColumns": [
                        {"mDataProp": "id"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/samples/deleteSampleType'); ?>",
                        data: {id: id},
                        beforeSend: function() {
