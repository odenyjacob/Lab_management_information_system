			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: CRITICAL VALUE REPORTING :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Critical Value Reporting Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/cvr/popupadd/">Add new CVR</a>
            <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/cvr/getCvrTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "cvr_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "month"},
                    {"mDataProp": "reported"},
                    {"mDataProp": "all_events"},
                    {"mDataProp": "report_percentage"},
                    {"mDataProp": "target"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "insights"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/cvr/deleteCvr'); ?>",
                        data: {cvr_id: id},
                        beforeSend: function() {
