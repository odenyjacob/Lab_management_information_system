			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: TAT TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> TAT Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/tat/popupadd/">Add new TAT</a>
            <br/>
            ...
            <table cellpadding="0" cellspacing="0" class="displayGrid" id="dealList"  style="width: 100% ">
                <thead>
                    <tr>
                        <th width="90px" >tat id</th>
                        <th>year</th>
                        <th>months</th>
                        <th>meeting meeting</th>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/tat/getTatTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "tat_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "month"},
                    {"mDataProp": "samples_meeting_tat"},
                    {"mDataProp": "total_samples_released"},
                    {"mDataProp": "pc_meeting_tat"},
                    {"mDataProp": "target"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "insights"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/tat/deleteTat'); ?>",
                        data: {tat_id: id},
                        beforeSend: function() {
