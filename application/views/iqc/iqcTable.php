			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: IQC TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Internal Quality Control Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/iqc/popupadd/">Add new IQC</a>
            <br/>
            <!-- start data table here-->
            <table cellpadding="0" cellspacing="0" class="displayGrid" id="dealList"  style="width: 100%">
                <thead>
                    <tr>
                        <th width="80px" >iqc id</th>
                        <th>year</th>
                        <th>month</th>
                        <th>passed run 1</th>
                        <th>total done</th>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/iqc/getIqcTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "iqc_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "month"},
                    {"mDataProp": "iqcs_passed_firstRun"},
                    {"mDataProp": "iqcs_done"},
                    {"mDataProp": "pc_iqcs_passed_firstRun"},
                    {"mDataProp": "target"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "insights"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/iqc/deleteIqc'); ?>",
                        data: {iqc_id: id},
                        beforeSend: function() {
