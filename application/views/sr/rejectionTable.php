			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: SAMPLE REJECTION TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Sample Rejection Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/samples/popupadd/">Add new Rejection</a>
            <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/samples/getSRTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "sample_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "month"},
                    {"mDataProp": "rejected_samples"},
                    {"mDataProp": "total_received_samples"},
                    {"mDataProp": "rejection_percentage"},
                    {"mDataProp": "target"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "insights"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/samples/deleteSampleRejection'); ?>",
                        data: {sample_id: id},
                        beforeSend: function() {
