			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: PROJECTS :::</h3>  
			  		</div>
			  		<div class="panel-body"> 
			  			
		<h2><hr /> PROJECTS </h2>Studies and Projects  <hr />
        <div id="dynamic">

            <a class="various btn btn-sm btn-info" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/projects/popupadd/">Add Projects</a>
            <br/> <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/projects/getprojectsTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "id"},
                    {"mDataProp": "branch"},
                    {"mDataProp": "project"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/awards/deleteProject'); ?>",
                        data: {id: id},
                        beforeSend: function() {
