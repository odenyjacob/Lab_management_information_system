...
.bodyzoom:hover{
    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['Basophils %', 'Basophils Absolute', 'Eosinophils %', 'Eosinophils Absolute',  'Hematocrit', 'Hemoglobin', 'Lymphocytes %',
                'Lymphs Absolute', 'MCV', 'Monocytes %', 'Monocytes Absolute', 'Neut/Gran %', 'Neut/Gran Absolute', 'Platelet Count', 'RBC', 'WBC', 'MCH',
                'MCHC', 'RDW']
        },
        yAxis: {
            title: {
        ...
        series: [{
            name: 'Cycle A',
            data: [<?php echo $Basophilspcav.",". $BasophilsAbsoluteav.",". $Eosinophilspcav.",". $EosinophilsAbsoluteav.",". $Hematocritav.",". $Hemoglobinav.",". $Lymphocytespcav. ",". $LymphsAbsoluteav.",". $MCVav.",". $Monocytespcav .",". $MonocytesAbsoluteav .",". $NeutGranpcav .",". $NeutGranAbsoluteav .",". 
            				  $PlateletCountav .",". $RBCav .",". $WBCav .",". $MCHav .",". $MCHCav .",". $RDWav ;?>]
         },{
            name: 'Cycle B',
            data: [<?php echo $Basophilspcbv.",". $BasophilsAbsolutebv.",". $Eosinophilspcbv.",". $EosinophilsAbsolutebv.",". $Hematocritbv.",". $Hemoglobinbv.",". $Lymphocytespcbv. ",". $LymphsAbsolutebv.",". $MCVbv.",". $Monocytespcbv .",". $MonocytesAbsolutebv .",". $NeutGranpcbv .",". $NeutGranAbsolutebv .",". 
            				  $PlateletCountbv .",". $RBCbv .",". $WBCbv .",". $MCHbv .",". $MCHCbv .",". $RDWbv ;?>]
         },{
            name: 'Cycle C',
            data: [<?php echo $Basophilspccv.",". $BasophilsAbsolutecv.",". $Eosinophilspccv.",". $EosinophilsAbsolutecv.",". $Hematocritcv.",". $Hemoglobincv.",". $Lymphocytespccv. ",". $LymphsAbsolutecv.",". $MCVcv.",". $Monocytespccv .",". $MonocytesAbsolutecv .",". $NeutGranpccv .",". $NeutGranAbsolutecv .",". 
            				  $PlateletCountcv .",". $RBCcv .",". $WBCcv .",". $MCHcv .",". $MCHCcv .",". $RDWcv ;?>]
         },{
            name: 'Target',
			...
			<div class="col-md-12 col-md-offset-0">		
				...
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		...
			  		<div class="panel-body"> 
						...
						<div id="accordion">
							  <h3>CHART : HEMATOLOGY (<?php echo $year; ?>) </h3>
							<div>
