...
.bodyzoom:hover{
    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['Anti-HIV-1/2', 'Anti-HBc (Total)', 'Anti-HCV', 'Anti-HIV-1 (Mtd 1)',  'Anti-HIV-1 (Mtd 2)', 'Anti-HIV-1 WB Proteins', 'Anti-HIV-1 WB, Result',
                'HBeAg', 'HBsAg']
        },
        yAxis: {
            title: {
        ...
        series: [{
            name: 'Cycle A',
            data: [<?php echo $AntiHIVhalfav.",". $AntiHBcTotalav.",". $AntiHCVav.",". $AntiHIV1Mtd1av.",". $AntiHIV1Mtd2av.",". $AntiHIV1WBProteinsav.",". $AntiHIV1WBResultav. ",". $HBeAgav.",". $HBsAgav ;?>]
         },{
            name: 'Cycle B',
            data: [<?php echo $AntiHIVhalfbv.",". $AntiHBcTotalbv.",". $AntiHCVbv.",". $AntiHIV1Mtd1bv.",". $AntiHIV1Mtd2bv.",". $AntiHIV1WBProteinsbv.",". $AntiHIV1WBResultbv. ",". $HBeAgbv.",". $HBsAgbv ;?>]
         },{
            name: 'Cycle C',
            data: [<?php echo $AntiHIVhalfcv.",". $AntiHBcTotalcv.",". $AntiHCVcv.",". $AntiHIV1Mtd1cv.",". $AntiHIV1Mtd2cv.",". $AntiHIV1WBProteinscv.",". $AntiHIV1WBResultcv. ",". $HBeAgcv.",". $HBsAgcv ;?>]
         },{
            name: 'Target',
			...
			<div class="col-md-12 col-md-offset-0">		
				...
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		...
			  		<div class="panel-body"> 
						...
						<div id="accordion">
							  <h3>CHART : ELISA VIRAL MARKERS (<?php echo $year; ?>) </h3>
							<div>
