...
.bodyzoom:hover{
    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['Blood/Hgb, Urine', 'Bilirubin, Urine', 'Glucose, urine', 'hCG, urine',  'Ketones, urine', 'KOH prep', 'Leuko Esterase, urine',
                'pH, urine', 'Nitrite, urine', 'Protein, urine, qual', 'Spec Gravity, urine', 'Urine Sediment ID', 'Urobilinogen, urine',
                'Vaginal Wet prep', 'Yeast/Clue Cells, Vaginal']
        },
        yAxis: {
            title: {
               // text: 'Temperature (°C)'
        ...
        series: [{
            name: 'Cycle A',
            data: [<?php echo $BloodUrineav.",". $BilirubinUrineav.",". $Glucoseurineav .",". $hCGurineav .",". $Ketonesurineav .",". $KOHprepav .",". 
            				  $LeukoEsteraseUrineav .",". $pHurineav .",". $Nitriteurineav .",". $ProteinUrineQualav .",". $SpecGravityUrineav .",". $UrineSedimentIDav .",".
            				  $UrobilinogenUrineav .",". $VaginalWetPrepav .",". $YeastClueCellsVaginalav ;?>]
         },{
            name: 'Cycle B',
            data: [<?php echo $BloodUrinebv.",". $BilirubinUrinebv.",". $Glucoseurinebv .",". $hCGurinebv .",". $Ketonesurinebv .",". $KOHprepbv .",". 
            				  $LeukoEsteraseUrinebv .",". $pHurinebv .",". $Nitriteurinebv .",". $ProteinUrineQualbv .",". $SpecGravityUrinecv .",". $UrineSedimentIDbv .",".
            				  $UrobilinogenUrinebv .",". $VaginalWetPrepbv .",". $YeastClueCellsVaginalbv ;?>]
         },{
            name: 'Cycle C',
            data: [<?php echo $BloodUrinecv.",". $BilirubinUrinecv.",". $Glucoseurinecv .",". $hCGurinecv .",". $Ketonesurinecv .",". $KOHprepcv .",". 
            				  $LeukoEsteraseUrinecv .",". $pHurinecv .",". $Nitriteurinecv .",". $ProteinUrineQualcv .",". $SpecGravityUrinecv .",". $UrineSedimentIDcv .",".
            				  $UrobilinogenUrinebv .",". $VaginalWetPrepcv .",". $YeastClueCellsVaginalcv ;?>]
         },{
            name: 'Target',
			...
			<div class="col-md-12 col-md-offset-0">		
				...
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		...
			  		<div class="panel-body"> 
						...
						<div id="accordion">
							  <h3>CHART : EQA URINALYSIS (<?php echo $year; ?>) </h3>
							<div>
