...
.bodyzoom:hover{
    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['Albumin', 'Alkaline Phosphatase', 'ALT (SGPT)', 'AST (SGOT)',  'Bilirubin, total', 'CO2', 'Calcium',
                'Chloride', 'Cholesterol - HDL', 'Cholesterol - LDL, measured', 'Cholesterol - Total', 'Creatine', 'Creatinine Kinase',
                'FSH', 'Glucose', 'Lactate', 'Lipase', 'Phosphorus', 'Potassium', 'Protein, total', 'Sodium', 'Triglycerides', 'Urea Nitrogen (BUN)', 'Calcium']
        },
        yAxis: {
            title: {
               // text: 'Temperature (°C)'
        ...
        series: [{
            name: 'Cycle A',
            data: [<?php echo $Albuminav.",". $AlkalinePhosphataseav.",". $ALTav .",". $ASTav .",". $BilirubinTotalav .",". $C02av .",". 
            				  $Calciumav .",". $Chlorideav .",". $CholesteralHDLav .",". $CholesteralLDLMeasuredav .",". $CholesteralTotalcv .",". $Creatinineav .",".
            				  $CreatinineKinaseav .",". $FSHav .",". $Glucoseav .",". $Lactateav .",". $Lipaseav .",". $Phosphorusav .",".
            				  $Potassiumav .",". $ProteinTotalav .",". $Sodiumav .",". $Triglyceridesav .",". $UreaNitBunav ;?>]
         },{
            name: 'Cycle B',
            data: [<?php echo $Albuminbv.",". $AlkalinePhosphatasebv.",". $ALTbv .",". $ASTbv .",". $BilirubinTotalbv .",". $C02bv .",". 
            				  $Calciumbv .",". $Chloridebv .",". $CholesteralHDLbv .",". $CholesteralLDLMeasuredbv .",". $CholesteralTotalbv .",". $Creatininebv .",".
            				  $CreatinineKinasebv .",". $FSHbv .",". $Glucosebv .",". $Lactatebv .",". $Lipasebv .",". $Phosphorusbv .",".
            				  $Potassiumbv .",". $ProteinTotalbv .",". $Sodiumbv .",". $Triglyceridesbv .",". $UreaNitBunbv ;?>]
         },{
            name: 'Cycle C',
            data: [<?php echo $Albumincv.",". $AlkalinePhosphatasecv.",". $ALTcv .",". $ASTcv .",". $BilirubinTotalcv .",". $C02cv .",". 
            				  $Calciumcv .",". $Chloridecv .",". $CholesteralHDLcv .",". $CholesteralLDLMeasuredcv .",". $CholesteralTotalcv .",". $Creatininecv .",".
            				  $CreatinineKinasecv .",". $FSHbv .",". $Glucosecv .",". $Lactatecv .",". $Lipasecv .",". $Phosphoruscv .",".
            				  $Potassiumcv .",". $ProteinTotalcv .",". $Sodiumcv .",". $Triglyceridescv .",". $UreaNitBuncv ;?>]
         },{
            name: 'Target',
			...
			<div class="col-md-12 col-md-offset-0">		
				...
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		...
			  		<div class="panel-body"> 
						...
						<div id="accordion">
							  <h3>EQA Chemistry Chart (<?php echo $year; ?>) </h3>
							<div>
