			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: BLOOD CELL, PARASITE & TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> EQA Rapid HIV & Others Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/rapidHiv/popupadd/">Add new Rapid Hiv</a>
            <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/rapidHiv/getRapidHivTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "rapidHiv_id"}, 
                    {"mDataProp": "year"},
                    {"mDataProp": "cycle"},
                    {"mDataProp": "parameter"},
                    {"mDataProp": "results"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/rapidHiv/deleteRapidHiv'); ?>",
                        data: {rapidHiv_id: id},
                        beforeSend: function() {
