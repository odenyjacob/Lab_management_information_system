...
.bodyzoom:hover{
    ...
    $('#container').highcharts({
        ...
        xAxis: {
            categories: ['HSV II, IgG', 'Anti-HIV-1/2 (Mtd 1)', 'Anti-HIV-1/2 (Mtd 2)', 'hCG, urine', 'MHA-TP/TP-PA/PK-TP', 'RPR, qual', 'RPR, titer']
        },
        yAxis: {
            title: {
               // text: 'Temperature (°C)'
        ...
        series: [{
            name: 'Cycle A',
            data: [<?php echo $HSVIIIgGav.",". $AntiHIVhalfMtd1av.",". $AntiHIVhalfMtd2av.",". $hCGurineav.",". $MHATPTPPAPKTPav.",". $RPRqualav.",". $RPRtiterav ;?>]
         },{
            name: 'Cycle B',
            data: [<?php echo $HSVIIIgGbv.",". $AntiHIVhalfMtd1bv.",". $AntiHIVhalfMtd2bv.",". $hCGurinebv.",". $MHATPTPPAPKTPbv.",". $RPRqualbv.",". $RPRtiterbv ;?>]
         },{
            name: 'Cycle C',
            data: [<?php echo $HSVIIIgGcv.",". $AntiHIVhalfMtd1cv.",". $AntiHIVhalfMtd2cv.",". $hCGurinebv.",". $MHATPTPPAPKTPcv.",". $RPRqualcv.",". $RPRtitercv ;?>]
         },{
            name: 'Target',
			...
			<div class="col-md-12 col-md-offset-0">		
				...
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		...
			  		<div class="panel-body"> 
						...
						<div id="accordion">
							  <h3>CHART : RAPID HIV & OTHERS (<?php echo $year; ?>) </h3>
							<div>
