			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: EQA HEMATOLOGY TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> EQA Hematology Table <hr /> </h2>
        <div id="dynamic">

            <a class="various" data-fancybox-type="iframe" href="<?= base_url() ?>index.php/hematology/popupadd/">Add new Hematology</a>
            <br/>
            <!-- start data table here-->
            <table cellpadding="0" cellspacing="0" class="displayGrid" id="dealList"  style="width: 100%">
                <thead>
                    <tr>
                        <th width="80px" >hematology id</th>
                        <th>year</th>
                        <th>cycle</th>
                        <th>parameter</th>
                        <th>results</th>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/hematology/getHematologyTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "hematology_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "cycle"},
                    {"mDataProp": "parameter"},
                    {"mDataProp": "results"},
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/hematology/deleteHematology'); ?>",
                        data: {hematology_id: id},
                        beforeSend: function() {
