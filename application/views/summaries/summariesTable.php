			...
			<div class="col-md-12 col-md-offset-0">				
				<div class="<?php echo $this->session->userdata('panel'); ?>">
			  		<div class="panel-heading">
			    		<h3 class="panel-title" align="center"> :::: SUMMARIES TABLE :::</h3>  
			  		</div>
			  		<div class="panel-body"> 

		  			
			  			
		<h2><hr /> Summaries Table <hr /> </h2>
        <div id="dynamic">

            <a class="various " data-fancybox-type="iframe" href="<?= base_url() ?>index.php/summaries/popupadd/">Add new Summary</a>
            <br/>
    ...
    <script>
     ...
     $(document).ready(function() {
            oTable = $('#dealList').dataTable({
                ...
                "bServerSide": true,
                "bRedraw": true,
                "sAjaxSource": "<?= base_url('index.php/summaries/getSummariesTable'); ?>",
                "aoColumns": [
                    {"mDataProp": "summaries_id"},
                    {"mDataProp": "year"},
                    {"mDataProp": "table_name"},
                    {"mDataProp": "analysis"},
                    {"mDataProp": "interpretation"},
                    {"mDataProp": "limitation"},
                    {"mDataProp": "action_plan"},
                    {"mDataProp": "userName"},
                    {"mDataProp": "timeStamp"},
                    {"mDataProp": "edit"},
                    {"mDataProp": "delete"}
        ...
        function deleteRecord(id) {
                ...
                if (r === true) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('index.php/summaries/deleteSummaries'); ?>",
