...
<div class="login">
<header class="login-header"><span class="text">Hover here to login!</span><span class="loader"></span></header> 
  
  
  	
  	<?php
  	$attributes = array('class' => 'login-form', 'id' => 'login-form');
    echo form_open('main/login_proc',$attributes);     
  	echo br(2); echo validation_errors(); ?>
